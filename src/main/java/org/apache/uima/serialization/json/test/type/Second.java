 ...
 * @generated */
public class Second extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Second.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Second() {/* intentionally empty block */}
   ...
   */
  public Second(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Second(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
